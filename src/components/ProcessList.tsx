 ...
 *  - 1fr 让给 PRJ 列吃掉剩余宽度（项目名长短不一，最适合伸缩）。Misc 实际只显示短
 *    标记（DS 端口 ":7777" 或 "---"），所以收紧到 max-content，避免跨度过长视觉空旷。
 */
export const PROC_COLS =
  "grid-cols-[minmax(64px,1fr)_max-content_minmax(48px,auto)_minmax(56px,auto)_minmax(56px,auto)_minmax(64px,auto)_minmax(72px,auto)_minmax(48px,auto)_minmax(48px,max-content)_minmax(56px,max-content)]";
