...
import { Skull, Cpu, MemoryStick, MonitorPlay } from "lucide-react";
  ...
  return (
    <div className="h-9 flex items-center gap-3 px-3 text-[11px] border-t border-border-subtle bg-black/20">
      ...
      <div className="text-text-secondary font-mono shrink-0">
        UE-CPU <span className="text-accent-cyan">{totalCpu.toFixed(1)}%</span>
      </div>
      <div className="text-text-secondary font-mono shrink-0">
        UE-MEM <span className="text-accent-cyan">
